...
public:
    ...
    void drawCubeWithTexture(Shader& lightingShaderWithTexture, glm::mat4 model = glm::mat4(1.0f))
    {
        ...
        lightingShaderWithTexture.setInt("textures.diffuse", 0);
        lightingShaderWithTexture.setInt("textures.specular", 1);
        lightingShaderWithTexture.setFloat("textures.shininess", this->shininess);

        lightingShaderWithTexture.setBool("drawWithTexture", true);
    ...
    void drawCubeWithMaterialisticProperty(Shader& lightingShader, glm::mat4 model = glm::mat4(1.0f))
    {
        ...
        lightingShader.setBool("drawWithTexture", false);
    ...
    void setMaterialisticEimu(float r, float g, float b) {
